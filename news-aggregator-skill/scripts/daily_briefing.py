...
from fetch_news import (
    ...
    fetch_latentspace_ainews, fetch_harness_engineering,
...
PROFILES = {
    # 1. 综合早报 (General Morning Routine) - 已移除社会新闻源
    "general": {
        "global_scan": {
            "sources": [
                ...
                (fetch_v2ex, 5, None),
                (fetch_latentspace_ainews, 5, None),
                (fetch_harness_engineering, 5, None)
            ],
            "enrich": True
        },
        "hn_ai": {
